...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    //포치픽 전체보기
    Page<Post> findByUserIdIn(List<Long> adminUserIds, Pageable pageable);

    //홈용 포치픽 - 관리자 작성 게시글, 최신순 상위 N개
    List<Post> findTopByUserIdInOrderByCreatedAtDesc(List<Long> adminUserIds, Pageable pageable);
