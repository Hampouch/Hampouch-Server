 ...
 * 이 화면 한정으로는 summary 계열 API를 또 호출하게 하는 게 불필요한 라운드트립이라 판단(0718 논의).
...
public record ExpenseDayListResponse(
     ...
     * customCategory/customEmotion 원문 대신 categoryLabel/emotionLabel(커스텀 태그일 때만 값 존재)을 내려줌(0718 명세서 재확인).
